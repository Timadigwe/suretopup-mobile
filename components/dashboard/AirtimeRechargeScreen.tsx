          ...
          <View style={styles.section}>
            ...
            {detectedNetwork ? (
              <View style={styles.networkCard}>
                <View style={styles.networkInfo}>
                  <View style={[
                    ...
                    { backgroundColor: getNetworkInfo(detectedNetwork).color + '20' }
                  ]}>
                    <Ionicons 
                      name={getNetworkInfo(detectedNetwork).icon as any} 
                      size={24} 
                      color={getNetworkInfo(detectedNetwork).color} 
                    />
                  </View>
                  <View style={styles.networkDetails}>
                    <Text style={[styles.networkName, { color: colors.text }]}>
                      {getNetworkInfo(detectedNetwork).name}
                    </Text>
              ...
              <TouchableOpacity
                ...
                onPress={() => setShowNetworkSelector(true)}
              >
                <Ionicons name="cellular" size={20} color={colors.mutedForeground} />

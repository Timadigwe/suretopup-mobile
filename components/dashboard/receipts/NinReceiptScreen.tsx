...
interface NinReceiptScreenProps {
  receiptData: NinReceiptData;
  onClose: () => void;
}

export const NinReceiptScreen: React.FC<NinReceiptScreenProps> = ({
  receiptData,
  onClose,
}) => {
        ...
        <ViewShot ref={viewShotRef} options={{ format: 'jpg', quality: 0.8 }}>
          <View style={[styles.receiptContainer, { backgroundColor: 'white' }]}>
            ...
            <View style={styles.receiptHeader}>
              <View style={styles.headerContent}>
                ...
                <View style={styles.headerText}>
                  ...
                  <Text style={styles.receiptTitle}>NIN Receipt</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.successIconContainer}>
              <View style={styles.ninIconContainer}>
            ...
            <View style={styles.successContainer}>
              <Text style={styles.successText}>
                NIN Slip Print Request Submitted!
              </Text>
              <Text style={styles.successSubtext}>
                Your NIN slip print request has been submitted successfully
              </Text>
            </View>
            ...
            <View style={styles.receiptDetails}>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailValue}>{receiptData.service || 'NIN Print'}</Text>
              </View>

              {receiptData.ninNumber && (
                <View style={styles.detailRow}>
                  <Text style={styles.detailLabel}>NIN Number</Text>
                  <Text style={styles.detailValue}>{receiptData.ninNumber}</Text>
                </View>
              )}

              {receiptData.slipType && (
                <View style={styles.detailRow}>
                  <Text style={styles.detailLabel}>Slip Type</Text>
                  <Text style={styles.detailValue}>{receiptData.slipType}</Text>
                </View>
              )}

              {receiptData.slipName && (
                <View style={styles.detailRow}>
                  <Text style={styles.detailLabel}>Slip Name</Text>
                  <Text style={styles.detailValue}>{receiptData.slipName}</Text>
                </View>
              )}

              {receiptData.info && receiptData.info.trim() !== '' && (
                <View style={styles.detailRow}>
              ...
              {selectedReceiptType === 'user' && (
                <>
                  {(receiptData.oldBalance || receiptData.old_balance) && (
                    <View style={styles.detailRow}>
                      <Text style={styles.detailLabel}>Previous Balance</Text>
                      <Text style={styles.detailValue}>
                        {formatAmount(parseFloat(receiptData.oldBalance || receiptData.old_balance || '0'))}
                      </Text>
                    </View>
                  )}
                  {(receiptData.newBalance || receiptData.new_balance) && (
                    <View style={styles.detailRow}>
                      <Text style={styles.detailLabel}>New Balance</Text>
                      <Text style={styles.detailValue}>
                        {formatAmount(parseFloat(receiptData.newBalance || receiptData.new_balance || '0'))}
                      </Text>
                    </View>
                  )}
                </>
              ...
              {/* Additional NIN Details */}

              {receiptData.slipPrice && (
                <View style={styles.detailRow}>
                  <Text style={styles.detailLabel}>Slip Price</Text>
                  <Text style={styles.detailValue}>{formatAmount(receiptData.slipPrice)}</Text>
                </View>
              )}
            </View>
            ...
            <View style={styles.statusNotice}>
              ...
              <Text style={styles.noticeText}>
                NIN info saved. Support will contact you as soon as possible.
              </Text>
            </View>
...
export default NinReceiptScreen;

  ...
  const handleShare = async () => {
    try {
      ...
      if (viewShot && viewShot.capture) {
        ...
        await Share.share({
          url: uri,
          message: `Electricity bill payment receipt for ${receiptData.serviceName || receiptData.service || 'N/A'} - ${formatAmount(receiptData.amount)}`,
        });
      }
    } catch (error) {
            ...
            <View style={styles.receiptHeader}>
              <View style={styles.headerContent}>
                ...
                <View style={styles.headerText}>
                  ...
                  <Text style={styles.receiptTitle}>Electricity Receipt</Text>
                </View>
              </View>
            </View>

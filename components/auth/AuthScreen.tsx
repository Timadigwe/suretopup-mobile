...
//   const { login, adminLogin, register, forgotPassword, isLoading: authLoading } = useAuth();
...
//       if (isAdminLogin) {
//         // Admin login
//         adminLogin(formData.username, formData.password).then((result) => {
//           setIsLoading(false);
//           if (result.success) {
//             onLogin();
//           } else {
//             const errorMessage = getUserFriendlyError(result.message, 'login');
//             showModal('Admin Login Failed', errorMessage, 'error');
//           }
//         });
//       } else {
//         // User login
...
//                 {isAdminLogin ? (
//                   renderInput('person', 'Enter your username', formData.username, 'username', 'default', undefined, undefined, undefined, 'Username')
//                 ) : (
...
//                   </Text>
//                   <TouchableOpacity onPress={toggleAdminMode} style={styles.toggleButtonContainer}>
//                     <Text style={[styles.toggleButton, { color: colors.primary }]}>
